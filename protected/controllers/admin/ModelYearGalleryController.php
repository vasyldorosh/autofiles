 ...
 *  - Arrange images in Salon
 *  - Changing name/description associated with image
 *
 */

class ModelYearGalleryController extends CController
{
    /**
    ...
    public function actionDelete()
    {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            $id = $_POST['id'];
            /** @var $photo AutoModelYearPhoto */
            $photo = AutoModelYearPhoto::model()->findByPk($id);
    ...
    public function actionAjaxUpload($gallery_id = null)
    {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
            ...
            $model = new AutoModelYearPhoto();
			$model->year_id = $gallery_id;
    ...
    public function actionChangeData()
    {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            ...
            /** @var $models AutoModelYearPhoto[] */
            $models = AutoModelYearPhoto::model()->findAll($criteria);
