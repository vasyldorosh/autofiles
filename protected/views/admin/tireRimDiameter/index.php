<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Tire Rim Diameters');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Tire Rim Diameters')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('tire.rim_diameter.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/tireRimDiameter/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
    ...
    <div class="grid">
		...
		if (Access::is('tire.rim_diameter.update') || Access::is('tire.rim_diameter.delete')) {
			$template = array();
			if (Access::is('tire.rim_diameter.update')) $template[] = '{update}';
			if (Access::is('tire.rim_diameter.delete')) $template[] = '{delete}';
