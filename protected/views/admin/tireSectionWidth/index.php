<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Tire Speed Indexs');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Tire Speed Indexs')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('tire.section_width.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/tireSectionWidth/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
    ...
    <div class="grid">
		...
		if (Access::is('tire.section_width.update') || Access::is('tire.section_width.delete')) {
			$template = array();
			if (Access::is('tire.section_width.update')) $template[] = '{update}';
			if (Access::is('tire.section_width.delete')) $template[] = '{delete}';
