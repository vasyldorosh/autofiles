<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Rim Center Bore');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Rim Center Bore')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('tire.rim.center_bore.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/rimCenterBore/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
