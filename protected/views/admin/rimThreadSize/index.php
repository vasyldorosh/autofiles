<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Rim Thread Size');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Rim Thread Size')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('tire.rim.thread_size.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/rimThreadSize/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
    ...
    <div class="grid">
		...
		if (Access::is('tire.rim.thread_size.update') || Access::is('tire.rim.thread_size.delete')) {
			$template = array();
			if (Access::is('tire.rim.thread_size.update')) $template[] = '{update}';
			if (Access::is('tire.rim.thread_size.delete')) $template[] = '{delete}';
