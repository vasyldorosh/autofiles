<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Basket Models');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Basket Models')?></h3>
    </div>
    ...
    <div class="grid">
		...
		$this->widget('bootstrap.widgets.TbExtendedGridView', array(
			...
			'ajaxUrl'=> $this->createUrl('/admin/model/basket'),
            'filter' => $model,
