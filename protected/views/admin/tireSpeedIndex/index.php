...
<div class="container inner-page white img-rounded">
	...
	<div class="button">
		<?php if (Access::is('tire.speed_index.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/tireSpeedIndex/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
    ...
    <div class="grid">
		...
		if (Access::is('tire.speed_index.update') || Access::is('tire.speed_index.delete')) {
			$template = array();
			if (Access::is('tire.speed_index.update')) $template[] = '{update}';
			if (Access::is('tire.speed_index.delete')) $template[] = '{delete}';
