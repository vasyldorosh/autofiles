<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Rim Width');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Rim Width')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('tire.rim.width.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/rimWidth/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
    ...
    <div class="grid">
		...
		if (Access::is('tire.rim.width.update') || Access::is('tire.rim.width.delete')) {
			$template = array();
			if (Access::is('tire.rim.width.update')) $template[] = '{update}';
			if (Access::is('tire.rim.width.delete')) $template[] = '{delete}';
