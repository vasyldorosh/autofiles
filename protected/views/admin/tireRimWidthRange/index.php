<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Tire Rim Width ranges');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Tire Rim Width ranges')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('tire.create')):?>
			...
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/tireRimWidthRange/create"), 'icon' => 'file white'),
				),
			))?>
			...
			<? /*$this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'primary',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Import'), 'url' => Yii::app()->createUrl("admin/tireRimWidthRange/index?import=1")),
				),
			))*/?>
