<?php $this->pageTitle = Yii::app()->name.' - ' . Yii::t('admin', 'Platform');?>

<div class="container inner-page white img-rounded">
    <div class="page-header">
        <h3><?=Yii::t('admin', 'Platform')?></h3>
    </div>
	...
	<div class="button">
		<?php if (Access::is('modelYear.platform.create')):?>
			<? $this->widget("bootstrap.widgets.TbButtonGroup", array(
				'type' => 'success',
				'buttons' => array(
					array('label' => Yii::t('admin', 'Create'), 'url' => Yii::app()->createUrl("admin/platform/create"), 'icon' => 'file white'),
				),
			))?>
		<?php endif;?>
    ...
    <div class="grid">
		...
		$columns = array(
				...
				array(
					...
					'filter' => PlatformCategory::getAll(),					
				),				
				'title',
				'alias',
            );
