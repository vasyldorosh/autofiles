	...
	<div class="l-col1">
		...
		<section class="table-container">
			...
			<tbody>
				...
				<tr>
					<td><h3><?=$model['title']?> Bolt Pattern</h3></td>
				...
				<tr>
					<td><h3>Stock wheel offset</h3></td>
				...
				<tr>
					<td><h3>Custom Offset Range</h3></td>
				...
				<tr>
					<td><h3>Thread size</h3></td>
					<td><h3><?=$wheelsDataItem['thread_size']?></h3></td>					
				</tr>
				<?php endif;?>				
				
				<tr>
					<td><h3>Stock Rim Sizes Range</h3></td>
				...
				<tr>
					<td><h3>Custom rim sizes range</h3> </td>
...
<br>
<h2>Rim Sizes Range</h2>
<p>Gives an idea about the maximum and minimum allowable limits of the wheels diameter and width matching the specific vehicle. <a target="_blank" rel="nofollow" href="http://www.amazon.com/gp/search?ie=UTF8&camp=1789&creative=9325&index=automotive&keywords=hubcaps&linkCode=ur2&tag=auto036-20&linkId=SAMMREJTPRAVTXQ4"><b>Try Hubcaps</b></a><img src="http://ir-na.amazon-adsystem.com/e/ir?t=auto036-20&l=ur2&o=1" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important;" />  to change the look of your wheels
</p>

<br>
<h2>Custom Rim Sizes Range</h2>
...
<br>
<h2>Tire Sizes</h2>
<p>Scale from the minimum to the maximum available options of the wheel dimensions that may fit <?=$make['title']?> <?=$model['title']?></p>
